...
const birthdayBackdrop = document.getElementById("birthday-backdrop");
const playlist = [
  {
...
function closeMessageModal() {
  ...
  if (birthdayModal) {
    ...
    birthdayModal.style.display = "grid";
  }
}
...
if (messageClose && messageModal) {
  messageClose.addEventListener("click", () => {
    closeMessageModal();
  });
}

if (messageBackdrop && messageModal) {
  messageBackdrop.addEventListener("click", () => {
    closeMessageModal();
  });
}
...
if (birthdayBackdrop && birthdayModal) {
  birthdayBackdrop.addEventListener("click", () => {
    closeBirthdayModal();
  });
}
...
document.addEventListener("keydown", (event) => {
  ...
  if (event.key === "Escape" && birthdayModal && !birthdayModal.hidden) {
    closeBirthdayModal();
  }
});
